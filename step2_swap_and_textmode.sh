...
chmod +x ~/fastai2_jetson_nano/step3_install_fastai2_no_virtualenv.sh
chmod +x ~/fastai2_jetson_nano/background/step3_install_fastai2_background.sh
chmod +x ~/fastai2_jetson_nano/background/step3_install_fastai2_background_no_virtualenv.sh
