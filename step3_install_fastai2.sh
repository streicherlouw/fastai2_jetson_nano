...
cp ~/fastai2_jetson_nano/startup_scripts/start_fastai_jupyter.sh start_fastai_jupyter.sh
...
cp ~/fastai2_jetson_nano/startup_scripts/start_fastai_jupyter_tmux.sh start_fastai_jupyter_tmux.sh
