...
With a reasonably fast SD card, following the process should take about 12-14 hours. It has been desinged to be fully automated, so it can be run unattended overnight. This work was inspired by the installation instructions for fastai V1 for the jetson nano written by [Bharat Kunwar](https://github.com/brtknr/fastai-jetson-nano).
