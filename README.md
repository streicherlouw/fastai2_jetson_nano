...
Start by opening a text terminal and download  the files you will need for the installation process from this github with the command:
```
...
```
./fastai2_jetson_nano/step_3_enable_gui.sh
```
